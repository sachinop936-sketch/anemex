        ...
        <section className="py-6">
          <div className="container">
            <div className="mb-4 flex items-center justify-center gap-2 rounded-full bg-card/80 p-2 backdrop-blur-sm card-shadow max-w-xs mx-auto">
              ...
              <span className="text-xs font-medium text-foreground">No Scam – 100% Real Service</span>
            </div>

            <h1 className="text-center text-2xl font-bold text-foreground mb-1">
              Book Your <span className="gradient-text">Service</span> Now
            </h1>
            <p className="text-center text-sm text-muted-foreground">Online sessions starting ₹79 only</p>
          </div>
        </section>
